...
// Используем онлайн видео вместо локального файла
const poolVideo = "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4";
                  ...
                  <div className="relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
                    <div className="p-4">
                      <img
                        ...
                        alt={category.name}
                        className="w-full h-52 object-contain object-center group-hover:scale-105 transition-transform duration-500 ease-out rounded-lg"
                      />
                    </div>
